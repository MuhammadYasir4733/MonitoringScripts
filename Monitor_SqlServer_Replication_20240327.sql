...
EXEC master.dbo.sp_addlinkedserver @server = N'SelfPointing', @srvproduct=N'', @provider=N'SQLNCLI', @provstr=N'DRIVER={SQL Server};Server=(local)\SQLSERVER1; Initial Catalog=distribution;uid=sa;pwd=Admin@3311;'
GO

EXEC master.dbo.sp_addlinkedsrvlogin @rmtsrvname=N'SelfPointing',@useself=N'False',@locallogin=NULL,@rmtuser=N'sa',@rmtpassword='Admin@3311'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'collation compatible', @optvalue=N'false'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'data access', @optvalue=N'true'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'dist', @optvalue=N'false'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'pub', @optvalue=N'false'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'rpc', @optvalue=N'true'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'rpc out', @optvalue=N'true'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'sub', @optvalue=N'false'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'connect timeout', @optvalue=N'0'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'collation name', @optvalue=null
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'lazy schema validation', @optvalue=N'false'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'query timeout', @optvalue=N'0'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'use remote collation', @optvalue=N'true'
GO

EXEC master.dbo.sp_serveroption @server=N'SelfPointing', @optname=N'remote proc transaction promotion', @optvalue=N'true'
GO
...
SELECT * FROM #tmp_publisher_monitordata;
